...
{
    public GameObject InventoryPanel;           // 인벤토리 패널 프리팹
    public List<Image> itemIconsImage;          // 인벤토리 아이템 아이콘 이미지 리스트
    ...
    // 재귀적으로 마지막 자식 오브젝트를 찾아 Image 컴포넌트를 리스트에 추가
    // ItemIcon 이미지를 업데이트하기 위해 사용
