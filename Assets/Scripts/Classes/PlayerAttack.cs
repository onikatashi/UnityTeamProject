...
{
    //공격력
    public float atkDmg = Player.Instance.finalStats.attackDamage;
    //공격 속도
    public float atkSpd = Player.Instance.finalStats.attackSpeed;
    //다음 공격을 위한 변수
    float nextAtkTime;
    //공격 범위
    public float atkRng = Player.Instance.finalStats.attackRange;
    //공격 각도(범위 공격)
